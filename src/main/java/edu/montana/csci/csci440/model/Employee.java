    ...
    public static List<Employee.SalesSummary> getSalesSummaries() {
        try (Connection conn = DB.connect();
             PreparedStatement stmt = conn.prepareStatement(
                     "SELECT e.FirstName, e.LastName, e.Email, COUNT(i.InvoiceId) as salesCount, SUM(i.Total) as salesTotal FROM employees e JOIN customers c on e.EmployeeId = c.SupportRepId JOIN invoices i on c.CustomerId = i.CustomerId GROUP BY EmployeeId"
             )) {
...
//        return Collections.emptyList();
    ...
    public Employee getBoss() {
        Employee employee = find(this.getReportsTo());
        //TODO implement
        return employee;
    }
    ...
    public void setReportsTo(Employee employee) {
        setReportsTo(employee.employeeId);
        // TODO implement
    }
    ...
    public static class SalesSummary {
        ...
        public BigDecimal getSalesTotals() {
            salesTotals = salesTotals.setScale(2, BigDecimal.ROUND_DOWN);
            return salesTotals;
        }
    }
}
